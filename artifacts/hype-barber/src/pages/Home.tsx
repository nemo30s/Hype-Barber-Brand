    ...
    <main className="w-full">
      ...
      <section className="relative h-screen w-full flex flex-col justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img
            src="/pexels-nickoloui-1319459.jpg"
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 flex flex-col justify-center h-full">
            ...
            {["YOUR", "STYLE.", "ELEVATED."].map((word, i) => (
              <div key={word} className="overflow-hidden">
                <motion.h1
                  ...
                  className="font-display text-[18vw] leading-[0.85] md:text-[12vw] lg:text-9xl m-0 p-0"
                  style={
                    i === 2
                      ? { WebkitTextStroke: "3px white", color: "transparent" }
                      : { color: "white" }
                  }
                >
                  {word}
          ...
          <motion.p
            ...
            className="text-base md:text-xl text-foreground/80 max-w-md font-body font-light mb-6 md:mb-10"
          >
            Klapdorp 24, Antwerp. <br />
            <span className="font-accent italic text-foreground opacity-90">
              Where street culture meets precision.
            </span>
          </motion.p>
      ...
      <section
        id="about"
        className="py-24 md:py-40 max-w-7xl mx-auto px-6 md:px-12"
      >
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            <h2 className="text-5xl md:text-7xl mb-6">
              MORE THAN A{" "}
              <span className="font-accent italic tracking-normal normal-case">
                HAIRCUT.
              </span>
            </h2>
            <p className="text-lg text-muted-foreground font-light mb-8 leading-relaxed">
              Located at Klapdorp 24, HYPE Barber is redefining the grooming
              experience. We are an inclusive space where premium craftsmanship
              meets street culture. Whether you need a classic fade, specialized
              afro hair care, or exclusive grooming products from our concept
              store — you belong here.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid md:grid-cols-5 gap-12 items-center">
          ...
          >
            <h2 className="text-5xl md:text-7xl mb-6 text-background">
              BORN IN ANTWERP. <br />
              <span className="text-background/50">BUILT FOR EVERYONE.</span>
            </h2>
            <p className="text-xl text-background/80 max-w-2xl">
              We aren't just cutting hair; we're curating an identity. The HYPE
              aesthetic is raw, refined, and undeniably authentic. Our concept
              store features hand-picked apparel and premium grooming products
              designed to elevate your everyday routine.
            </p>
          </motion.div>
        </div>
      </section>
            ...
            {[
              {
                num: "01",
                name: "Haircut",
                desc: "Classic to creative cuts tailored to your personal style and head shape.",
                price: "From €25",
              },
              {
                num: "02",
                name: "Fade & Taper",
                desc: "Precision skin fades and smooth tapers for a sharp, flawless look.",
                price: "From €25",
              },
              {
                num: "03",
                name: "Beard Sculpt",
                desc: "Shape, trim, and define your beard with hot towel expert precision.",
                price: "From €15",
              },

              {
                num: "04",
                name: "Kids' Cut",
                desc: "Gentle, patient, and fun haircuts for our youngest clients.",
                price: "From €20",
              },
              {
                num: "05",
                name: "Snit All In",
                desc: "The ultimate package — premium cut, beard sculpting and styling.",
                price: "From €35",
              },
              {
                num: "06",
                name: "Cornrows",
                desc: "Neat, tight, and expertly braided — from simple straight-backs to intricate patterns. Available in 2, 4, 6 rows and beyond.",
                price: "From €40",
              },
            ].map((service, i) => (
              <motion.div
                ...
                <div className="relative z-10 h-full flex flex-col">
                  ...
                  <div className="flex items-center justify-between mt-auto pt-6 border-t border-border">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="opacity-0 group-hover:opacity-100 transition-opacity text-primary text-sm font-bold uppercase tracking-widest flex items-center gap-1"
                    >
            ...
            <div className="md:col-span-1">
              ...
              >
                <h2 className="text-6xl md:text-7xl mb-6">
                  CONCEPT <br />
                  <span className="text-background/50">STORE.</span>
                </h2>
                <p className="text-lg text-background/80 mb-8">
                  Elevate your daily routine with our curated selection of
                  premium hair and beard care products. Tested by our barbers,
      ...
      >
        ...
        >
          ...
          <p className="text-muted-foreground mt-4 text-lg">
            Meet the artists behind the chairs.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-16 max-w-4xl mx-auto">
          {[
            {
              name: "Bright",
              role: "Master Barber · Fades & Afro Specialist",
              img: "https://cdn-partners-api.fresha.com/employee-avatars/processed/389730/medium/5213661d-7044-4294-abd0-45fa29393a85-2024-01-07_11h27_22%20(2).png",
            },
            {
              name: "Gjerry",
              role: "Senior Stylist · All Hair Types",
              img: "https://cdn-partners-api.fresha.com/employee-avatars/processed/389732/medium/691c2bed-a321-4db8-8a2c-31b99e58a49a-EAB5B203-7233-41D9-9DC1-8EC3C6205D1F.jpeg",
            },
          ].map((barber, i) => (
            <motion.div
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 w-full p-8 translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                ...
                <Button
                  className="w-full opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100"
                  asChild
                >
                  <a
                    href="https://www.fresha.com/a/hype-barbershop-antwerpen-klapdorp-24-yfruiva1"
      ...
      <section className="py-24 bg-card border-y border-border overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 md:px-12 mb-16">
          ...
          <p className="text-foreground/40 uppercase tracking-widest text-sm mt-4">
            Click a reel to watch
          </p>
        </div>
      ...
      <section className="py-24 md:py-40 max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {[
            {
              quote:
                "Walked in for a basic cut, walked out feeling like a new person. Bright is an absolute artist — the attention to detail is unmatched. Already booked my next appointment.",
              author: "Mehdi K.",
            },
            {
              quote:
                "Best barbershop in Antwerp, hands down. The vibe is immaculate, the music is on point, and Gjerry knows exactly what he's doing. The concept store products are great too.",
              author: "Thomas V.",
            },
          ].map((review, i) => (
            <motion.div
      ...
      <section className="relative py-40 overflow-hidden bg-black flex items-center justify-center">
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none opacity-[0.03] select-none">
          <span className="font-display text-[30vw] leading-none whitespace-nowrap">
            HYPE
          </span>
        </div>
        ...
        >
          ...
          <p className="text-xl text-muted-foreground font-light mb-10">
            Reserve your chair at Klapdorp 24, Antwerp. Walk-ins are welcome,
            but appointments guarantee your spot.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button size="lg" variant="outline" asChild>
              <a
                href="https://www.instagram.com/hype_barbershop/"
                target="_blank"
                rel="noopener noreferrer"
              >
      ...
      <div className="bg-primary text-primary-foreground py-8">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 text-sm font-bold uppercase tracking-widest">
          <a
            href="https://maps.google.com/?q=Klapdorp+24+Antwerp"
            target="_blank"
            rel="noopener noreferrer"
